...
Permission Role API
- API version: v1
  - Build date: 2025-11-01T10:51:13.706160+07:00[Asia/Ho_Chi_Minh]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**listRoles**](docs/DefaultApi.md#listRoles) | **POST** /api/v1/permissionrole/list | Get list of permission roles


## Documentation for Models

 - [ApiResponseListRole](docs/ApiResponseListRole.md)
